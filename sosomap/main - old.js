(function() {
    ...
    function kb(a) {
        ...
        this.markers = [];
        var b = this;
        b.clickListener = $f.addListener(this.icon, "click",
        function() {
    ...
    Q.changed = function(a) { ("gridSize" === a || "maxZoom" === a || "minimumClusterSize" === a) && this.reloadView()
    };
    ...
    var tl = function() {
        function a() {
            var a = ql + "default/imgs/markercluster/m",
            b = [];
            Qa([53, 56, 66, 78, 90],
            function(d, f) {
                b.push({
